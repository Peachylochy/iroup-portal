...
function getV2SampleDataBatches_() {
  ...
  batches[IROUP_V2_SHEETS.PERSON_STUDENT] = [
    { student_id: 'TEST-STU-001', prefix_th: 'นาย', first_name_th: 'Fake Student One', last_name_th: 'Sample', full_name_th: 'Fake Student One Sample', prefix_en: 'Mr.', first_name_en: 'Fake Student One', last_name_en: 'Sample', full_name_en: 'Mr. Fake Student One Sample', gender: 'male', unit_id: 'TEST-UNIT-SCI', program_th: 'Test Science Program', degree_level: 'bachelor', student_status: 'active', active: true, source_system: 'MANUAL_CSV', updated_at: now },
    { student_id: 'TEST-STU-002', prefix_th: 'นางสาว', first_name_th: 'Fake Student Two', last_name_th: 'Sample', full_name_th: 'Fake Student Two Sample', prefix_en: 'Ms.', first_name_en: 'Fake Student Two', last_name_en: 'Sample', full_name_en: 'Ms. Fake Student Two Sample', gender: 'female', unit_id: 'TEST-UNIT-ENG', program_th: 'Test Engineering Program', degree_level: 'master', student_status: 'active', active: true, source_system: 'MANUAL_CSV', updated_at: now },
    { student_id: 'TEST-STU-003', prefix_th: 'นาย', first_name_th: 'Inactive Student', last_name_th: 'Sample', full_name_th: 'Inactive Student Sample', prefix_en: 'Mr.', first_name_en: 'Inactive Student', last_name_en: 'Sample', full_name_en: 'Mr. Inactive Student Sample', gender: 'male', unit_id: 'TEST-UNIT-SCI', program_th: 'Inactive Program', degree_level: 'bachelor', student_status: 'inactive', active: false, source_system: 'MANUAL_CSV', updated_at: now }
  ];
