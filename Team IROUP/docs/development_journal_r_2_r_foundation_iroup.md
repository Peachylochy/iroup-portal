...
## Personal IR Workspace for Peach
...
Operational workspace and lightweight information ecosystem developed to support:

- International Relations operations
- MOU management
- mobility tracking
- scholarship/event management
- reporting workflows
- public information communication
- evidence collection and organizational knowledge management
...
Develop a low-cost operational ecosystem that:

- reduces repetitive work
- centralizes information
- improves reporting workflows
- supports public communication
- improves accessibility of operational data
- supports long-term organizational knowledge retention
- supports professional development and future R2R work
...
into a practical system that can evolve gradually over time.

---

# 3. Initial Pain Points

## 3.1 Information Fragmentation

Before development:

- information existed across many Google Sheets
- files were scattered across personal folders
- workflows depended heavily on manual searching
- operational knowledge depended on memory
- evidence collection for reports was difficult
...
- difficulty tracking historical information
- operational stress during reporting periods

---

## 3.2 Manual Operational Workflows

Several workflows were heavily manual:
...
## 3.3 Lack of Centralized Public Information

Public information lacked:
...
## 3.4 Difficulty Collecting Professional Evidence
...
was difficult to collect consistently.

Problems included:

- missing records
- inconsistent storage
- scattered screenshots/files
...
## 4.1 Start From Real Operational Problems

The system is designed from:

- actual workflow pain points
- operational bottlenecks
- recurring administrative tasks
- public communication needs

rather than abstract technical experimentation.

---

## 4.2 Low-Cost Sustainable Technology
...
The project evolves gradually through:
...
still depend on human judgment and real operational experience.
...
- low abstraction
- highly manual structure

---

## Dashboard Expansion Stage

Focus areas expanded into:
...
- duplication increased rapidly
- maintainability problems emerged
- inconsistent UI patterns appeared
...
↓
Apps Script APIs (Logic Layer)
↓
Shared Utilities + Shared Theme
↓
Reusable Components
↓
...
GitHub Workflow
↓
Scalable Operational Ecosystem
...
# 7. AI-Assisted Development Reflections

## Observed Benefits

AI significantly helped with:
...
- scope is controlled
- workflows are understood first
...
- unnecessary rewrites are attempted
...
> operational staff with strong workflow understanding can build meaningful systems using AI-assisted development, even without traditional software engineering backgrounds.

---

# 8. Workflow Improvements Observed

## Improvements Already Seen

### Information Access

- operational information became easier to locate
- searchability improved
- centralized structure reduced confusion

---

### Reporting Workflow

- report preparation became faster
- repeated formatting work decreased
- operational summaries became easier to generate

---

### Public Communication

- scholarship/event visibility improved
- centralized public pages improved consistency
- information updates became easier

---

### Development Workflow

After Git/GitHub adoption:

- changes became safer
- rollback became possible
- migrations became more controlled
- architecture planning improved
- development continuity improved across devices

---

# 9. Quantitative Impact Tracking

> Update continuously as measurable improvements become clearer.

| Area | Before | After | Notes |
|------|--------|------|------|
| Report preparation time | TBD | TBD | |
| Time spent searching files | TBD | TBD | |
| Duplicate files/workflows | TBD | TBD | |
| Centralized workflows | TBD | TBD | |
| Manual formatting work | TBD | TBD | |

Potential future metrics:

- reduction in repetitive work
- number of operational modules centralized
- number of public workflows improved
- reduction in reporting preparation time
- reduction in duplicated data entry

---

# 10. Technical Challenges Encountered

## Frontend Challenges

- duplicated utility functions
- inconsistent styling systems
- mixed mock/real data rendering
...
- deployment/versioning management
- API consistency
- Google Drive integration
- asynchronous rendering coordination

---

## Operational Challenges

- development occurring alongside real work
- evolving requirements
- balancing stability vs experimentation
- avoiding over-refactoring

---

# 11. Personal Reflection Notes

## Systems Thinking Development

Over time, development shifted from:

- isolated page editing

toward:

- maintainable systems thinking
- migration planning
...
> understanding workflows and operational pain points is often more valuable than knowing advanced syntax.

---

## Lessons About AI

AI is most effective when combined with:
...
Large systems become unstable when:

- optimization happens too early
- architecture is rewritten repeatedly
- features expand faster than stabilization
...
## Potential R2R Themes

### Theme 1

“Development of an International Relations Operational Management System Using Low-Cost Technology and AI-Assisted Development”

---

### Theme 2

“Application of AI-Assisted Development for Supporting Operational Workflows in International Relations Administration”

---

### Theme 3

“Development of a Lightweight Information System to Improve International Relations Operational Efficiency”

---

## Possible Organizational Contributions
...
- public communication improvement
- reduced repetitive administrative work

---

## Possible Professional Contributions
...
- R2R development
- professional advancement
- operational innovation portfolio development
...
# 14. Future Roadmap Notes

## Short-Term Focus

- stabilize utility migration
- improve responsive behavior
- reduce duplicated logic
- stabilize public pages
...
- maintainable IR operational infrastructure
- AI-assisted operational analytics
- reusable university operational model

---

# 15. Reflection Prompts (Update Weekly)

## Operational Reflection

- Which workflow consumed the most time this week?
- Which feature reduced operational burden the most?
- Which workflow remains difficult?
- Which repetitive task should be automated next?

---

## Technical Reflection

- Which architecture decisions worked well?
- Which areas are becoming technical debt?
- Which pages are becoming difficult to maintain?
- What should be modularized next?

---

## Professional Reflection

- How does the system improve organizational workflows?
- What new skills were developed?
- How can this evolve into institutional innovation?
- Which improvements are measurable now?

---

# 16. Notes for Future Sessions

Before continuing development:

- review PROJECT-STATE.md first
- review migration risks before refactoring
- avoid unnecessary architectural rewrites
- prioritize stabilization before optimization
- prefer incremental and reversible migrations
- preserve working operational workflows
...
This project is not only a technical exercise.

It is an evolving attempt to combine:
...
into a practical operational ecosystem that can:
...
37. Admin Stabilization Pass 1 (May 10, 2026)
...
40. V2.2 Header Repair And Seed Diagnostics (May 11, 2026)

Summary

V2.2 backend foundation progressed through header repair, seed diagnostics, auth/API DTO scaffolding, and test-runner verification, but Router/API endpoint work is blocked by a physical seed write-position issue in Google Sheets.

Completed V2 backend foundation work now includes:
...
- Created `IROUP_V2_REPAIR.gs`.
- Ran `repairV22Headers()`.
- Header repair succeeded for `FILE_ROLE_MASTER`, `PUBLIC_CACHE`, and `TRAVEL_PARTICIPANT`.
- Reran `seedV2SampleData()`.
- Seed diagnostics reported `failed=0`.

Important correction

Although seed diagnostics reported `failed=0`, physical inspection/debug showed many seed records were appended after preformatted checkbox/validation rows around row 1000+, rather than starting at row 2.
...
- V2 Router/API endpoint layer: not ready and blocked until Seed Write Position Fix Pass is completed.

Root cause hypothesis

The seed writer likely uses `appendRow()` or `getLastRow()+1`. Google Sheets can count preformatted/validated checkbox rows as used rows, so sample data lands after those rows instead of the first logical empty data row.

Next required phase

Seed Write Position Fix Pass:
...
- Add a helper such as `findFirstEmptyRowByKey_(sheet, keyColumnIndex)`.
- Use primary key / ID column, usually column A, to find the first truly empty row.
...
41. V2.2 Seed Write Position Fix Pass Complete (May 11, 2026)

Summary

V2.2 Seed Write Position Fix Pass completed successfully. The V2 backend foundation is now validated and ready for the V2 Router/API endpoint layer.

What happened

- Previous seed validation passed, but physical rows were appended after preformatted checkbox/validation rows around row 1000+.
- Google Sheets counted formatted checkbox/validation rows as used rows.
- The root cause was `appendRow()` / `getLastRow()+1` behavior with preformatted checkbox ranges.

Fix implemented in `IROUP_V2_DB.gs`
...
- Writes now locate the first truly empty key row, usually column A.
...
68. Travel Page V2 Read-Only List Sidecar (May 11, 2026)

Summary

Added a controlled V2 admin read-only sidecar to `travel.html` only. The page still renders from the existing V1 travel pipeline, and V2 is used only as a non-blocking travel list readiness check.

Implementation

- Updated `Team IROUP/travel.html`.
- Loaded `iroup-v2-endpoint.js` and `iroup-v2-api.js` between `iroup-config.js` and `iroup-utils.js`.
- Added `#v2TravelReadiness` with default text `V2 travel: checking`.
- Added page-local `v2TravelList`.
- Added travel-scoped `getV2TravelBridgeSession()` using existing V1 session metadata without exposing token values.
- Added `fetchV2TravelListSidecar()` using `IROUP_V2.admin.travelList()`.
- Called the V2 sidecar only after successful V1 load/render.

Preserved V1 travel flow

- Travel, staff, and country reads remain V1-backed.
- KPIs, filters, table rows, modal hydration, exports, staff selector, and upload flow remain V1-backed.
- `submitTravel()` remains unchanged.
- `deleteTravel()` remains unchanged.
- `quickAddStaff()` remains unchanged.
- `uploadFileFromInput()` remains unchanged.

Still not doing

- V1 `SCRIPT_URL` replacement
- travel render-source replacement
- V2 data feeding into KPIs/table/filters/export
- CRUD/write/upload migration
...
70. Event Metadata Write Dry-Run Contract (May 11, 2026)
...
- Requires existing V2 admin auth.
- Validates payload shape.
- Normalizes event metadata into a preview of the V2 `EVENT` row shape.
- Resolves country and organizer unit references where possible.
- Returns warnings for unresolved display fallbacks.
...
## News V2-Native Baseline (May 2026)

Cover:

- Added NEWS as a new V2 transaction module with schema support:
  `news_id`, TH/EN title/content, publish date, category, SDG tags, credit,
  link URL, public visibility, soft delete, and audit fields.
- Added NEWS admin route baseline:
  `v2.admin.news.list`, `v2.admin.news.detail`, `v2.admin.news.create`,
  `v2.admin.news.update`, and `v2.admin.news.delete`.
- Created `news.html` as a V2-native admin page with Card/List views, KPI cards,
  category and SDG filters, TH/EN display toggle, create/edit modal, and soft delete.
- Added SDG 1-17 checkbox workflow; selected values are stored as comma-separated
  `sdg_tags`.
- Added FILES relation upload wiring for NEWS:
  - `module = news`
  - `file_role_id = cover` for one cover image
  - `file_role_id = image` for content images
  - `visibility_level = public`
- Added `news` to `IROUP_V2_MODULES` so the existing file upload validator accepts
  NEWS files.
- Added NEWS to the real shared sidebar generator `js/iroup-sidebar.js`, and also
  to the static `dashboard.html` sidebar block.

Lesson learned:

- The visible admin sidebar is generated by `js/iroup-sidebar.js`; patching only
  each page's static sidebar is not enough.
- NEWS needs the normal login path to preserve Google token session storage:
  `index.html` login -> `dashboard.html` -> sidebar `ข่าว`.
- Apps Script sheet creation cannot be run from the local workspace; the live
  spreadsheet still needs `ensureV2NewsSheet_()` run manually, plus test data seeding.
- File upload module validation depends on `IROUP_V2_MODULES`; every new module that
  writes FILES relations must be added to that allowlist.

---

## Knowledge V2-Native Baseline + Sidebar Unification (May 2026)

Cover:

- Created `knowledge.html` as a new V2-native admin page for the Knowledge module.
- Routes added: v2.admin.knowledge.list, v2.admin.knowledge.detail,
  v2.admin.knowledge.create, v2.admin.knowledge.update, v2.admin.knowledge.delete.
- FILES relation wired: module=knowledge, file_role_id=image (up to 10 images),
  file_role_id=pdf (single PDF file).
- Features: Card/List views, TH/EN toggle, KPI cards (3), text/category/file-type
  filters, create/edit modal, video_url, link_url, pdf_url, public_visible toggle,
  soft delete, V2_KNOWLEDGE_WRITE_UI_ENABLED feature flag.
- Browser-validated end-to-end: card renders, save succeeds, images upload correctly.
- Discovered and fixed sidebar inconsistency: news.html and knowledge.html were using
  inline hardcoded sidebar HTML instead of the shared iroup-sidebar.js generator.
  Both pages were migrated to use iroup-sidebar.js.
- KN คลังความรู้ entry added to iroup-sidebar.js between NW ข่าว and รายงาน & Export.
- Fixed modal z-index conflict in news.html and knowledge.html: iroup-sidebar.js
  uses z-index 99999, so modals must use z-index 100000 or higher.
- Fixed dark input field bug in knowledge.html caused by CSS cascade from
  iroup-theme.css overriding the modal form field background color.

Lesson learned:

- Any new admin page that uses iroup-sidebar.js must set modal z-index ≥ 100000.
- Inline sidebar HTML is a maintenance risk; all admin pages should use
  iroup-sidebar.js so sidebar changes only need to happen in one place.
- New modules added to FILES relation must also be added to IROUP_V2_MODULES
  in the backend for file upload validation to pass.
- CSS cascade from global theme files can silently override modal form styles;
  use !important on critical form field properties when a global theme is present.
---

## Public News V2 Page (May 2026)

Cover:

- Created `public/public-news.html` as the public-safe V2 NEWS page.
- Confirmed the backend route `v2.public.news.list` and frontend wrapper
  `IROUP_V2.public.newsList()` already existed, so no new public route was needed.
- The page loads runtime data only from `IROUP_V2.public.newsList()`.
- Features added:
  - card grid
  - TH/EN toggle
  - category filter
  - SDG filter and SDG badges
  - detail modal
  - cover image from public FILES relation
  - content image strip from public FILES relation
  - loading, empty, and error states
- Public NEWS DTO was adjusted to prefer `file_role_id = cover` for cover images and
  fall back to `file_role_id = image`.

Lesson learned:

- Public NEWS had already been added to the V2 route layer; the real work was page
  activation and verifying public-safe field/file exposure.
- Public pages should continue using the isolated endpoint sequence:
  `iroup-config.js` -> `iroup-v2-endpoint.js` -> `iroup-v2-api.js`.
- Public file rendering should never infer from admin state; it should consume only
  files already filtered by the backend public FILES safety rules.
- Public page navigation changes, such as adding NEWS to `public-landing.html`, should
  be handled separately from the data-route activation pass.

---

## Public NEWS & Knowledge V2 Activation + UX Alignment (May 2026)
...
- Added public NEWS gallery/lightbox behavior:
  - thumbnail click
  - modal image gallery
...
- Performed admin visual alignment pass:
  ...
  - `news.html`
  - `knowledge.html`
- Standardized dark admin shell direction, KPI spacing, filter bar rhythm, modal
  shell styling, and sidebar consistency.
...
## Knowledge Cover Image Support (2026-05-17)

Cover:

- Added dedicated Knowledge cover-image support without backend contract changes.
  This pass introduces a separate รูปปก (cover image) field for the Knowledge module,
  keeping cover and gallery images as distinct upload roles in the existing FILES
  relation layer.

Implementation notes:

- `knowledge.html`:
  - Added a dedicated รูปปก upload/preview section in the create/edit modal.
  - Cover uploads write `file_role_id = cover` to the FILES relation.
  - Gallery image uploads continue to write `file_role_id = image`.
  - Upload progress, retry handling, lightweight diagnostics, and sequential upload
    behavior are fully preserved.
- `public-knowledge.html`:
  - Public Knowledge cards now select their display image using an explicit priority
    order: cover image (`file_role_id = cover`) → first gallery image
    (`file_role_id = image`) → placeholder.
- `public-knowledge-detail.html`:
  - The hero section of the detail view prioritizes the dedicated cover image.
  - The gallery section remains independent and does not include the cover image.
- Preserved throughout:
  - V2 endpoint strategy and public route layer.
  - Public privacy filtering and DTO compatibility.
  - Existing upload architecture.
- No backend/App Script changes were required.
...
- Browser smoke tests passed:
  - Admin cover picker is visible in the knowledge.html modal.
  - Public Knowledge list cover rendering works correctly.
  - Detail hero cover rendering works correctly.
  - No console errors observed.

Lessons learned:

- Separating cover and gallery roles in `file_role_id` is the correct approach for
  modules that need a hero/cover presentation distinct from a general media gallery.
  This pattern does not require backend contract changes; only the upload call site
  and the public card/detail rendering need to be updated.
- Public card image selection should always use an explicit fallback chain rather than
  assuming the first file in a FILES list is the intended cover.

Strategic direction:

Knowledge articles are evolving from generic repository records into
